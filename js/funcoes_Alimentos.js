$(function(){
	function Adicionar(){
		$("#tblAlimentos tbody").append(
			...
			"<td  data-label='Tp Alimento:'><input type='text' id='txtTpAlimento'/></td>"+
	...
	function Salvar(){
		...
		var tdTpAlimento = par.children("td:nth-child(3)");
		...
		if(document.getElementById('txtTpAlimento').value== ""){
	      alert('Por favor, preencha o campo "Tp Alimento"');
	      document.getElementById('txtTpAlimento').focus();
          return false
		}
		...
		tdTpAlimento.html(tdTpAlimento.children("input[type=text]").val());
	...
	function Editar(){
		...
		tdTpAlimento.html("<input type='text' id='txtTpAlimento' value='"+tdTpAlimento.html()+"'/>");
